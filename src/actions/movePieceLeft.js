const _movePieceLeft = (currentPiece, grid, setCurrentPiece, setGrid) => {
    let aux = [...grid];
    let nPiece = {...currentPiece};

    switch(nPiece.type){
        case 0:{
            let line = Math.trunc(currentPiece.blocks[3]/10);

            if(currentPiece.rotate == 0 && currentPiece.blocks[0]-1 >= line*10 && aux[currentPiece.blocks[0]-1].color == null){
            ...
            }else if(currentPiece.blocks[3]-1 >= line*10 && aux[currentPiece.blocks[0]-1].color == null && aux[currentPiece.blocks[1]-1].color == null && aux[currentPiece.blocks[2]-1].color == null && aux[currentPiece.blocks[3]-1].color == null){
